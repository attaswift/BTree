//
//  SortedAssociativeCollectionType.swift
//  TreeCollections
//
...
public protocol SortedAssociativeCollectionType: AssociativeCollectionType {
...
/// - Complexity: O(count)
@warn_unused_result
public func ==<C: SortedAssociativeCollectionType where C.Value: Equatable, C.Generator.Element == (C.Key, C.Value)>
    (a: C, b: C) -> Bool {
